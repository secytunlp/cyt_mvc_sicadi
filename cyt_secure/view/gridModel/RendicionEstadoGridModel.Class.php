...
/**
 * GridModel para Rendicion Estado
 *
 * @author Marcos
 * @since 07-03-2016
 */
class RendicionEstadoGridModel extends GridModel {

	public function RendicionEstadoGridModel() {
	...
	protected function initModel() {
		...
		$column = GridModelBuilder::buildColumn( "ds_investigador", CYT_LBL_SOLICITUD_SOLICITANTE, 50, CDT_CMP_GRID_TEXTALIGN_LEFT, "ds_investigador" ) ;
		$this->addColumn( $column );
		...
		$this->buildAction("cambiarEstadoRendicion_init", "cambiarEstadoRendicion_init", CYT_MSG_SOLICITUD_ESTADO_CAMBIAR, "image", "edit");
	...
	public function getEntityManager() {
		return CYTSecureManagerFactory::getRendicionEstadoManager();
	}
