...
/**
 * GridModel para listar CYTUsers.
 * 
 * @author Marcos
 * @since 10-11-2013
 * 
 */
class CYTUserGridModel extends GridModel{
	...
	protected function initModel(){
		...
		$column = GridModelBuilder::buildColumn( "oid", CYT_LBL_ENTITY_OID, 15, CDT_CMP_GRID_TEXTALIGN_RIGHT );
